...
import io.github.causewaystuff.commons.base.listing.Listing.MergePolicy;
...
class ListingTest {
    ...
    private final ListingHandler<Customer> listingHandler =
            new ListingHandler<Customer>(Customer.class, Customer::stringify, Customer::destringify, Customer::id);
