...
public final class MemberInfo {
    ...
    private MemberInfo(final int accessFlags, final String name, final String descriptor,
                       final AttributeInfo annotations, final String signature, final int codeSize) {
    ...
    static MemberInfo fromData(final DataInputStream in, final ConstantPool constantPool) throws IOException {
    ...
    public Set<String> getReferencedClasses() { return Set.copyOf(referencedClasses); }
